...
//DFU STATES
     ...
     *               </ul>
     * @param currBlkNo current block number in progress
     * @param totalBlocks total blocks to be upgraded
     */
    void onDfuStatus(byte status, int currBlkNo, int totalBlocks);
